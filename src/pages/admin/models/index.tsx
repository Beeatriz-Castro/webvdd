...
import { listPersonalizaveis, deletePersonalizavel, type ProdutoPersonalizavel } from "@/lib/api/personalizaveis";
...
export const AdminModelsPage = () => {
  ...
  const pendingProduct = models.find((m) => m.id === pendingDeleteId);
  ...
  return (
    <>
      <ConfirmDialog
        ...
        message={`Tem a certeza que deseja excluir "${pendingProduct?.nome}"? Esta ação não pode ser desfeita.`}
